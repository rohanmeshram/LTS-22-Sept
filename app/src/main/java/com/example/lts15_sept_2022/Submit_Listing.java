...
public class Submit_Listing extends AppCompatActivity {
 ...
 private final String url="http://10.0.2.2/lts_Android/db_insert.php";
 ...
 protected void onCreate(Bundle savedInstanceState) {
  ...
  bt_submit.setOnClickListener(new View.OnClickListener() {
   ...
   public void onClick(View view) {
    ...
    String cat = sp_parent.getAdapter().toString();
    String sub_cat = sp_child.getAdapter().toString();
    String owner = ed_owner.getText().toString();
    String email = ed_email.getText().toString();
    String password = ed_pass.getText().toString();
    String city = sp_city.getAdapter().toString();
 ...
 //======== End Of Bundle =======================================================
 //============ Start of process function for DB Insert =========================

 private void process()
 {

  final String title = ed_title.getText().toString().trim();
  final String cat = sp_parent.getSelectedItem().toString().trim();
  final String sub_cat = sp_child.getSelectedItem().toString().trim();
  final String owner = ed_owner.getText().toString().trim();
  ...
  final String pin = ed_pin.getText().toString().trim();
  final String mob = ed_mob.getText().toString().trim();
  ...
  StringRequest request=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
   ...
   protected Map<String, String> getParams() throws AuthFailureError
   {
    ...
    param.put("ed_title",title);
    param.put("sp_parent",cat);
    param.put("sp_child",sub_cat);
    param.put("ed_owner",owner);
    param.put("ed_email",email);
    param.put("ed_pass",password);
    param.put("sp_city",city);
    param.put("ed_address",address);
    param.put("ed_pin",pin);
    param.put("ed_mob",mob);
    param.put("ed_phone",phone);
    return param;
   }
  };
 ...
 private boolean validationInfo(String title, String owner, String email, String password, String address, String pin, String mob, String phone) {
  if (title.length() == 0) {
   ...
   ed_pass.requestFocus();
   ed_pass.setError("Enter Alpha Numeric Password NO Special Symbols");
   return false;
  }
   ...
   ed_mob.requestFocus();
   ed_mob.setError("Enter Valid Mobile Number");
   return false;
  }
